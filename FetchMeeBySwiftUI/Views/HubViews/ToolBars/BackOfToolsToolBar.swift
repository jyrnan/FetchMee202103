    ...
    var body: some View {
        HStack {
            ...
            Button(action: {
                ...
                swifter.fastDeleteTweets(for: fetchMee.loginUser.id, willDeleteCount: 2, keepRecent: fetchMee.loginUser.setting.isKeepRecentTweets,  completeHandler: completeHandler, logHandler: lh)
            }, label: {
                VStack{
